...
public class trader_quest3 extends script.base_script
{
    public trader_quest3()
    {
    }
    ...
    public void action_grantQuest3(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        if (item == menu_info_types.ITEM_USE)
        {
            if (hasObjVar(self, "intUsed"))
            {
                sendSystemMessage(player, new string_id("stardust/quest", "trader_quest3"));
                action_grantQuest3(player, self);
                return SCRIPT_CONTINUE;
            }
        }
        return SCRIPT_CONTINUE;
