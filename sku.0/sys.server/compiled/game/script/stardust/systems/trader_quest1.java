...
public class trader_quest1 extends script.base_script
{
    public trader_quest1()
    {
    }
    ...
    public void action_grantQuest1(obj_id player, obj_id npc) throws InterruptedException
    {
