...
public class cantina_actor_jar_jar extends script.base_script
{
    public cantina_actor_jar_jar()
    {
    }
    ...
    public int OnArrivedAtLocation(obj_id self, String name) throws InterruptedException
    {
        if (name.equals("startBosskLine1"))
        {
            ...
            {
                chat.chat(self, chat.CHAT_SAY, chat.MOOD_GOOFY, new string_id(STF_FILE, "meesa_entertaining"));
