...
public class cantina_actor_hondo extends script.base_script
{
    public cantina_actor_hondo()
    {
    }
    ...
    public int OnArrivedAtLocation(obj_id self, String name) throws InterruptedException
    {
        ...
        {
            if (!hasScript(self, "conversation.event_hondo"))
            {
                chat.chat(self, chat.CHAT_SAY, chat.MOOD_JOYFUL, new string_id(STF_FILE, "totally_legitimate_business_deals"));
                attachScript(self, "conversation.event_hondo");
