...
public class darth_oblivion extends script.base_script
{
    public darth_oblivion()
    {
    }
    public static final String c_stringFile = "conversation/darth_oblivion";
    public static final String OBJ_VAR_BASE = "darth_oblivion.";
    public static final String SITH_APPRENTICE = OBJ_VAR_BASE + "sith";
    public boolean darth_oblivion_defaultCondition()
    {
        return true;
    }
    public boolean darth_oblivion_language_condition(obj_id npc, obj_id player) throws InterruptedException
    {
    ...
    public boolean darth_oblivion_phase2_condition(obj_id npc, obj_id player)
    {
        return hasSkill(player,"class_forcesensitive_phase2_novice");
    }
    public boolean darth_oblivion_phase3_condition(obj_id npc, obj_id player)
    {
        return hasSkill(player,"class_forcesensitive_phase3_novice");
    }
    public boolean darth_oblivion_phase4_condition(obj_id npc, obj_id player)
    {
        return hasSkill(player,"class_forcesensitive_phase4_novice");
    }
    public boolean darth_oblivion_credits_condition(obj_id player, obj_id npc) throws InterruptedException
    {
        return (money.hasFunds(player, money.MT_TOTAL, smuggler.TIER_4_GENERIC_PVP_FRONT_COST));
    }
    public boolean darth_oblivion_hasObjVar_condition(obj_id npc, obj_id player)
    {
        return hasObjVar(player, SITH_APPRENTICE);
    }
    public boolean darth_oblivion_sith_quest_condition_playerFinishedMainTask(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "stardust_darth_oblivion", "talktodarth_oblivion");
    }
    public void darth_oblivion_sith_signalReward(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "stardust_entertainer_darth_oblivion_reward");
    }
    public void darth_oblivion_action_vendor(obj_id player, obj_id npc) throws InterruptedException
    {
        final dictionary d = new dictionary();
        d.put("player", player);
        messageTo(npc, "showInventorySUI", d, 0, false);
    }
    public void darth_oblivion_sith_quest(obj_id player, obj_id npc) throws InterruptedException
    {
        String pTemplate = getSkillTemplate(player);
        groundquests.grantQuest(player, "stardust_sith_darth_oblivion");
    }
    public void darth_oblivion_bounty_quest(obj_id player, obj_id npc) throws InterruptedException
    {
        money.requestPayment(player, npc, smuggler.TIER_4_GENERIC_PVP_FRONT_COST, "none", null, true);
        groundquests.requestGrantQuest(player, "quest/stardust_darth_oblivion_arena", true);
    ...
    public int darth_oblivion_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("seek_trade"))
        {
            ...
            utils.setScriptVar(player, "conversation.darth_oblivion_conversation.branchId", 2);
        ...
        else if (response.equals("seek_jedi"))
        {
            ...
            utils.removeScriptVar(player, "conversation.darth_oblivion_conversation.branchId");
        ...
        else if (response.equals("seek_balance"))
        {
            ...
            utils.setScriptVar(player, "conversation.darth_oblivion_conversation.branchId", 3);
        ...
        else if (response.equals("seek_sith"))
        {
            ...
            utils.setScriptVar(player, "conversation.darth_oblivion_conversation.branchId", 4);
    ...
    public int darth_oblivion_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("force_trade"))
        {
            if (darth_oblivion_sithFriend_condition(npc, player))
            {
                final string_id message = new string_id(c_stringFile, "npc_offer_trade");

                darth_oblivion_action_vendor(player, npc);
    ...
    public int darth_oblivion_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("seek_balance2"))
        {
            if (darth_oblivion_phase1_condition(npc, player))
            {
    ...
    public int darth_oblivion_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int OnInitialize(obj_id self) throws InterruptedException
    {
        ...
        setName(self, "Darth Oblivion (an Acolyte of The Beyond)");
    ...
    public int OnStartNpcConversation(obj_id npc, obj_id player) throws InterruptedException
    {
        ...
        if (darth_oblivion_language_condition(npc, player))
        {
            ...
            utils.setScriptVar(player, "conversation.darth_oblivion_conversation.branchId", 1);

            npcStartConversation(player, npc, "darth_oblivion_conversation", message, responses);
    ...
    {
        if (!conversationId.equals("darth_oblivion_conversation"))
        {
            return SCRIPT_CONTINUE;
        }

        final int branchId = utils.getIntScriptVar(player, "conversation.darth_oblivion_conversation.branchId");

        if (branchId == 1 && darth_oblivion_handleBranch1(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 2 && darth_oblivion_handleBranch2(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 3 && darth_oblivion_handleBranch3(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 4 && darth_oblivion_handleBranch4(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
