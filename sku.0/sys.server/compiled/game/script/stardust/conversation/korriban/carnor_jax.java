...
public class carnor_jax extends script.base_script
{
    public carnor_jax()
    {
    }
    public static final String c_stringFile = "conversation/carnor_jax";
    public static final String OBJ_VAR_BASE = "carnor_jax.";
    public static final String SITH_APPRENTICE = OBJ_VAR_BASE + "sith";
    public boolean carnor_jax_defaultCondition()
    {
        return true;
    }
    public boolean carnor_jax_language_condition(obj_id npc, obj_id player) throws InterruptedException
    {
    ...
    public boolean carnor_jax_phase2_condition(obj_id npc, obj_id player)
    {
        return hasSkill(player,"class_forcesensitive_phase2_novice");
    }
    public boolean carnor_jax_phase3_condition(obj_id npc, obj_id player)
    {
        return hasSkill(player,"class_forcesensitive_phase3_novice");
    }
    public boolean carnor_jax_phase4_condition(obj_id npc, obj_id player)
    {
        return hasSkill(player,"class_forcesensitive_phase4_novice");
    }
    public boolean carnor_jax_credits_condition(obj_id player, obj_id npc) throws InterruptedException
    {
        return (money.hasFunds(player, money.MT_TOTAL, smuggler.TIER_4_GENERIC_PVP_FRONT_COST));
    }
    public boolean carnor_jax_hasObjVar_condition(obj_id npc, obj_id player)
    {
        return hasObjVar(player, SITH_APPRENTICE);
    }
    public boolean carnor_jax_sith_quest_condition_playerFinishedMainTask(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "stardust_carnor_jax", "talktocarnor_jax");
    }
    public void carnor_jax_sith_signalReward(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "stardust_entertainer_carnor_jax_reward");
    }
    public void carnor_jax_action_vendor(obj_id player, obj_id npc) throws InterruptedException
    {
        final dictionary d = new dictionary();
        d.put("player", player);
        messageTo(npc, "showInventorySUI", d, 0, false);
    }
    public void carnor_jax_sith_quest(obj_id player, obj_id npc) throws InterruptedException
    {
        String pTemplate = getSkillTemplate(player);
        groundquests.grantQuest(player, "stardust_sith_carnor_jax");
    }
    public void carnor_jax_bounty_quest(obj_id player, obj_id npc) throws InterruptedException
    {
        money.requestPayment(player, npc, smuggler.TIER_4_GENERIC_PVP_FRONT_COST, "none", null, true);
        groundquests.requestGrantQuest(player, "quest/stardust_carnor_jax_arena", true);
    ...
    public int carnor_jax_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("seek_trade"))
        {
            ...
            utils.setScriptVar(player, "conversation.carnor_jax_conversation.branchId", 2);
        ...
        else if (response.equals("seek_jedi"))
        {
            ...
            utils.removeScriptVar(player, "conversation.carnor_jax_conversation.branchId");
        ...
        else if (response.equals("seek_balance"))
        {
            ...
            utils.setScriptVar(player, "conversation.carnor_jax_conversation.branchId", 3);
        ...
        else if (response.equals("seek_sith"))
        {
            ...
            utils.setScriptVar(player, "conversation.carnor_jax_conversation.branchId", 4);
    ...
    public int carnor_jax_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("force_trade"))
        {
            if (carnor_jax_sithFriend_condition(npc, player))
            {
                final string_id message = new string_id(c_stringFile, "npc_offer_trade");

                carnor_jax_action_vendor(player, npc);
    ...
    public int carnor_jax_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("seek_balance2"))
        {
            if (carnor_jax_phase1_condition(npc, player))
            {
    ...
    public int carnor_jax_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int OnInitialize(obj_id self) throws InterruptedException
    {
        ...
        setName(self, "Carnor Jax (Imperial Royal Guard)");
    ...
    public int OnStartNpcConversation(obj_id npc, obj_id player) throws InterruptedException
    {
        ...
        if (carnor_jax_language_condition(npc, player))
        {
            ...
            utils.setScriptVar(player, "conversation.carnor_jax_conversation.branchId", 1);

            npcStartConversation(player, npc, "carnor_jax_conversation", message, responses);
    ...
    {
        if (!conversationId.equals("carnor_jax_conversation"))
        {
            return SCRIPT_CONTINUE;
        }

        final int branchId = utils.getIntScriptVar(player, "conversation.carnor_jax_conversation.branchId");

        if (branchId == 1 && carnor_jax_handleBranch1(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 2 && carnor_jax_handleBranch2(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 3 && carnor_jax_handleBranch3(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 4 && carnor_jax_handleBranch4(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
