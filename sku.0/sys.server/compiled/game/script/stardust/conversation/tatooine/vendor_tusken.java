...
public class vendor_tusken extends script.base_script
{
    public vendor_tusken()
    {
    }
    public static String c_stringFile = "conversation/vendor_tusken";
    ...
    public int OnInitialize(obj_id self) throws InterruptedException
    {
        ...
        {
            detachScript(self, "conversation.vendor_tusken");
        }
    ...
    {
        setCondition(self, CONDITION_CONVERSABLE);
        setName(self, "KkH'Oar'Rrhr (Tusken Trade Merchant)");
        return SCRIPT_CONTINUE;
    }
    ...
    {
        if (!conversationId.equals("vendor_tusken"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
        int branchId = utils.getIntScriptVar(player, "conversation.vendor_tusken.branchId");
        chat.chat(npc, "Error:  Fell through all branches and responses for OnNpcConversationResponse.");
        utils.removeScriptVar(player, "conversation.vendor_tusken.branchId");
        return SCRIPT_CONTINUE;
    }
}
