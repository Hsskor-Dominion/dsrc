...
public class personel_imperial extends base_script
{
    public personel_imperial()
    {
    }
    public static String c_stringFile = "conversation/personel_imperial";
    public boolean personel_imperial_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean personel_imperialFriend_condition(obj_id player, obj_id npc) throws InterruptedException
    {
        float townFaction = factions.getFactionStanding(player, "Imperial");
        if (townFaction >= 50)
        {
            return true;
        }
    ...
    public void personel_imperial_action_grantHiring1(obj_id player, obj_id npc) throws InterruptedException
    {
        if (!pet_lib.hasMaxPets(player, pet_lib.PET_TYPE_NPC) && !pet_lib.hasMaxStoredPetsOfType(player, pet_lib.PET_TYPE_NPC))
        {
            location loc = getLocation(player);
            obj_id hireling = create.createCreature("imperial_reinforcement_1", loc, true);
    ...
    public void personel_imperial_action_grantHiring2(obj_id player, obj_id npc) throws InterruptedException
    {
        if (!pet_lib.hasMaxPets(player, pet_lib.PET_TYPE_NPC) && !pet_lib.hasMaxStoredPetsOfType(player, pet_lib.PET_TYPE_NPC))
        {
            location loc = getLocation(player);
            obj_id hireling = create.createCreature("imperial_reinforcement_2", loc, true);
            if (!isIdValid(hireling))
            {
                return;
            }
    ...
    public void personel_imperial_action_grantHiring3(obj_id player, obj_id npc) throws InterruptedException
    {
        if (!pet_lib.hasMaxPets(player, pet_lib.PET_TYPE_NPC) && !pet_lib.hasMaxStoredPetsOfType(player, pet_lib.PET_TYPE_NPC))
        {
            location loc = getLocation(player);
            obj_id hireling = create.createCreature("imperial_reinforcement_3", loc, true);
            if (!isIdValid(hireling))
            {
                return;
            }
    ...
    public void personel_imperial_action_grantHiring4(obj_id player, obj_id npc) throws InterruptedException
    {
        if (!pet_lib.hasMaxPets(player, pet_lib.PET_TYPE_NPC) && !pet_lib.hasMaxStoredPetsOfType(player, pet_lib.PET_TYPE_NPC))
        {
            location loc = getLocation(player);
            obj_id hireling = create.createCreature("imperial_reinforcement_4", loc, true);
            if (!isIdValid(hireling))
            {
                return;
            }
    ...
    public void personel_imperial_action_grantHiring5(obj_id player, obj_id npc) throws InterruptedException
    {
        if (!pet_lib.hasMaxPets(player, pet_lib.PET_TYPE_NPC) && !pet_lib.hasMaxStoredPetsOfType(player, pet_lib.PET_TYPE_NPC))
        {
            location loc = getLocation(player);
            obj_id hireling = create.createCreature("imperial_reinforcement_5", loc, true);
            if (!isIdValid(hireling))
            {
                return;
            }
    ...
    public int personel_imperial_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("seek_hireling"))
        {
            ...
            utils.setScriptVar(player, "conversation.personel_imperial_conversation.branchId", 2);
        ...
        else if (response.equals("seek_info"))
        {
            ...
            utils.setScriptVar(player, "conversation.personel_imperial_conversation.branchId", 3);
    ...
    public int personel_imperial_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("hireling_selection"))
        {
            if (personel_imperialFriend_condition(player, npc))
            {
                ...
                utils.setScriptVar(player, "conversation.personel_imperial_conversation.branchId", 4);
            ...
            else
            {
                ...
                utils.removeScriptVar(player, "conversation.personel_imperial_conversation.branchId");
    ...
    public int personel_imperial_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("seek_quest"))
        {
            if (personel_imperial_condition__defaultCondition(player, npc))
            {
                final string_id message = new string_id(c_stringFile, "seek_this");
                //personel_imperial_action_grantQuest(player, npc);
    ...
    public int personel_imperial_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        if (response.equals("hireling_selection_01"))
        {
            ...
            personel_imperial_action_grantHiring1(player, npc);
        ...
        else if (response.equals("hireling_selection_02"))
        {
            final string_id message = new string_id(c_stringFile, "hireling_commissioned");
            addUnmodifiedFactionStanding(player, hirelingFaction, -1000);
            personel_imperial_action_grantHiring2(player, npc);
        ...
        else if (response.equals("hireling_selection_03"))
        {
            final string_id message = new string_id(c_stringFile, "hireling_commissioned");
            addUnmodifiedFactionStanding(player, hirelingFaction, -1000);
            personel_imperial_action_grantHiring3(player, npc);
        ...
        else if (response.equals("hireling_selection_04"))
        {
            ...
            personel_imperial_action_grantHiring4(player, npc);
        ...
        else if (response.equals("hireling_selection_05"))
        {
            ...
            personel_imperial_action_grantHiring5(player, npc);
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        setCondition(self, CONDITION_CONVERSABLE);
        setCondition(self, CONDITION_INTERESTING);
        setName(self, "Mayfeld (a mercenary vendor)");
    ...
    public int OnStartNpcConversation(obj_id npc, obj_id player) throws InterruptedException
    {
        ...
        if (personel_imperial_condition__defaultCondition(npc, player))
        {
            ...
            utils.setScriptVar(player, "conversation.personel_imperial_conversation.branchId", 1);

            npcStartConversation(player, npc, "personel_imperial_conversation", message, responses);
            return SCRIPT_CONTINUE;
        }
    ...
    {
        if (!conversationId.equals("personel_imperial_conversation"))
        {
            return SCRIPT_CONTINUE;
        }

        final int branchId = utils.getIntScriptVar(player, "conversation.personel_imperial_conversation.branchId");

        if (branchId == 1 && personel_imperial_handleBranch1(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 2 && personel_imperial_handleBranch2(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 3 && personel_imperial_handleBranch3(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 4 && personel_imperial_handleBranch4(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
