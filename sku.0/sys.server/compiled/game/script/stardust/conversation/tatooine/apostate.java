...
public class apostate extends script.base_script
{
    ...
    public boolean apostateAlly_condition(obj_id player, obj_id npc) throws InterruptedException
    {
        float bhFaction = factions.getFactionStanding(player, "death_watch");
        if (bhFaction >= 2500)
        {
    ...
    public boolean apostateRank4_condition(obj_id player, obj_id npc) throws InterruptedException
    {
        float bhFaction = factions.getFactionStanding(player, "death_watch");
    ...
    public boolean apostateRank3_condition(obj_id player, obj_id npc) throws InterruptedException
    {
        float bhFaction = factions.getFactionStanding(player, "death_watch");
    ...
    public boolean apostateRank2_condition(obj_id player, obj_id npc) throws InterruptedException
    {
        float bhFaction = factions.getFactionStanding(player, "death_watch");
    ...
    public boolean apostateRank1_condition(obj_id player, obj_id npc) throws InterruptedException
    {
        float bhFaction = factions.getFactionStanding(player, "death_watch");
    ...
    public int apostate_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("become_mandalore"))
        {
            ...
            else if (apostateRank4_condition(player, npc) && apostate_condition_playerCompletedCreed(player, npc))
            {
                final string_id message = new string_id(c_stringFile, "for_new_mandalore");
                sendSystemMessage(player, new string_id("stardust/mando_rank", "mando_master4"));
            ...
            else if (apostateRank3_condition(player, npc) && apostate_condition_playerCompletedCreed(player, npc))
            {
                final string_id message = new string_id(c_stringFile, "for_new_mandalore");
                sendSystemMessage(player, new string_id("stardust/mando_rank", "mando_master3"));
            ...
            else if (apostateRank2_condition(player, npc) && apostate_condition_playerCompletedCreed(player, npc))
            {
                final string_id message = new string_id(c_stringFile, "for_new_mandalore");
                sendSystemMessage(player, new string_id("stardust/mando_rank", "mando_master2"));
            ...
            {
                final string_id message = new string_id(c_stringFile, "for_new_mandalore");
                sendSystemMessage(player, new string_id("stardust/mando_rank", "mando_master1"));
            ...
            else if (apostate_condition_playerCompletedCreed(player, npc))
            {
            ...
            else if (apostateAlly_condition(player, npc))
            {
