...
public class orf_initialize extends script.base_script
{
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        obj_id tower = getCellId(self, "core_tower8");
        if (!hasScript(tower, "theme_park.dungeon.mustafar_trials.old_republic_facility.core_tower"))
        {
            attachScript(tower, "theme_park.dungeon.mustafar_trials.old_republic_facility.core_tower");
        }
    ...
    {
        obj_id entrance = getCellId(self, "entrance");
        if (!hasScript(entrance, "theme_park.dungeon.mustafar_trials.old_republic_facility.core_tower"))
        {
            attachScript(entrance, "theme_park.dungeon.mustafar_trials.old_republic_facility.core_tower");
        }
        obj_id tower = getCellId(self, "core_tower8");
        if (!hasScript(tower, "theme_park.dungeon.mustafar_trials.old_republic_facility.core_tower"))
        {
