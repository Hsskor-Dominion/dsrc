...
{
    public String conversation = "conversation.aurilia_buff_vendor_convo_sith";
    public String c_stringFile = "conversation/aurilia_buff_vendor_convo";

    private void aurilia_buff_vendor_convo_sith_action_showTokenVendorUI(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary d = new dictionary();
        d.put("player", player);
        messageTo(npc, "showInventorySUI", d, 0, false);
    }
    public boolean aurilia_buff_vendor_convo_sith_language_condition(obj_id npc, obj_id player) throws InterruptedException
    {
...
// =====================================================
    ...
    public int aurilia_buff_vendor_convo_sith_handleBranch1(obj_id player, obj_id npc, string_id response)
            ...
            throws InterruptedException
    {
        ...
        utils.setScriptVar(player,
                "conversation.aurilia_buff_vendor_convo_sith_conversation.branchId",
                branchId);
...
// =====================================================
    ...
    public int aurilia_buff_vendor_convo_sith_handleBranch2(obj_id player, obj_id npc, string_id response)
            throws InterruptedException
    {
        String responseStr = response.toString();
        if (responseStr.contains(":"))
        ...
        aurilia_buff_vendor_convo_sith_action_showTokenVendorUI(player, npc);

        utils.removeScriptVarTree(player,
                "conversation.aurilia_buff_vendor_convo_sith_conversation");
    ...
    public int aurilia_buff_vendor_convo_sith_handleBranch3(obj_id player, obj_id npc, string_id response)
            throws InterruptedException
    {
        String responseStr = response.toString();
        if (responseStr.contains(":"))
        ...
        {
            groundquests.grantQuest(player, "stardust_holocron_aurillia");//replace with sith incade aurilia

            utils.removeScriptVarTree(player,
                    "conversation.aurilia_buff_vendor_convo_sith_conversation");

            npcEndConversationWithMessage(player,
                    new string_id(c_stringFile, "no_help_defend_village"));
            return SCRIPT_CONTINUE;
        }
...
// =====================================================
    ...
    public int aurilia_buff_vendor_convo_sith_handleBranch4(obj_id player, obj_id npc, string_id response)
            throws InterruptedException
    {
        String responseStr = response.toString();
        if (responseStr.contains(":"))
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        if (planetId == 11) {
            ...
            setName(self, "Baylon Skoll (Sith Enforcer)");
        }
        return SCRIPT_CONTINUE;
    }
    ...
    public int OnStartNpcConversation(obj_id npc, obj_id player) throws InterruptedException
    {
        ...
        if (aurilia_buff_vendor_convo_sith_language_condition(npc, player))
        {
            ...
            utils.setScriptVar(player, "conversation.aurilia_buff_vendor_convo_sith_conversation.branchId", 1);

            npcStartConversation(player, npc, "aurilia_buff_vendor_convo_sith_conversation", message, responses);
    ...
    {
        if (!conversationId.equals("aurilia_buff_vendor_convo_sith_conversation"))
        {
            return SCRIPT_CONTINUE;
        }
        final int branchId = utils.getIntScriptVar(player, "conversation.aurilia_buff_vendor_convo_sith_conversation.branchId");

        if (branchId == 1 && aurilia_buff_vendor_convo_sith_handleBranch1(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 2 && aurilia_buff_vendor_convo_sith_handleBranch2(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 3 && aurilia_buff_vendor_convo_sith_handleBranch3(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        else if (branchId == 4 && aurilia_buff_vendor_convo_sith_handleBranch4(player, npc, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        chat.chat(npc, "Error:  Fell through all branches and responses for OnNpcConversationResponse.");
        utils.removeScriptVar(player, "conversation.aurilia_buff_vendor_convo_sith_conversation.branchId");
        return SCRIPT_CONTINUE;
    }
