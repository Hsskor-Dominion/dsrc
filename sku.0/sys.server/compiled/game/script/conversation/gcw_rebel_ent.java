...
public class gcw_rebel_ent extends script.base_script
{
    ...
    {
        String pTemplate = getSkillTemplate(player);
        groundquests.grantQuest(player, "gcw_rebel_ent");
    }
